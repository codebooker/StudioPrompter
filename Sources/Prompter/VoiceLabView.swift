    ...
    private var commandsCard: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            DisclosureGroup("Command examples") {
                Text("Start / resume / let’s go\nGo back two lines\nStart this paragraph over\nStart from the top of the document\nMove down two paragraphs\nGo to the tenth paragraph\nGo to bookmark number two\nIncrease / decrease the font size\nSet font size to 48\nSwitch to Follow script / Adaptive pace / the other mode\nChange the font to Georgia\nIncrease line spacing\nMake side margins smaller\nShow / hide the reading guide\nMove the reading guide up / down\nMake the reading guide taller / shorter\nIncrease / decrease the line height\nSet guide height to two lines\nTurn focus current line on / off\nPause / cancel / stop listening")
