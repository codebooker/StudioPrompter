...
4. Tag the exact packaged commit as `0.1.1`. Upload the ZIP, DMG, `tester-appcast.xml`, `SHA256SUMS.txt`, and `BUILD-INFO.txt` to a draft GitHub release. Publish it as a **prerelease** after checks and smoke testing.
