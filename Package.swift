...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "PrompterLink", dependencies: ["PrompterCore"]),
        .executableTarget(name: "PrompterLinkChecks", dependencies: ["PrompterLink", "PrompterCore"], path: "Tests/PrompterLinkChecks"),
        ...
        .executableTarget(name: "Prompter", dependencies: ["PrompterCore", "PrompterSpeech", "PrompterLayout", "PrompterLink", .product(name: "Sparkle", package: "Sparkle")] + (experimentalCommands ? [.target(name: "PrompterCommands")] : []),
